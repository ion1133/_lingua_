...
class _MemorizeState extends State<Memorize> {
  ...
  int num = 1;
  var native = Page2.native;
  var fullname = Page2.full_name0;
  var memorize = Page2.memorize0;
  var do_you_know = Page2.do_you_know0;
  var do_you_rem = Page2.do_you_remember0;
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                          ...
                          child: Text('$memorize', style: TextStyle(fontSize: 20, color: Color(0xFF56B8FF), fontFamily: 'Inter'),),)
                      ],
                          ...
                          child: Stack(
                            children: [
                              ...
                              Container(
                                ...
                                child: Text('$yeah',style: TextStyle(fontFamily: 'Inter', fontSize: 25),),),
                            ],
                          ),
                        ),
                      ...
                      child: Stack(
                        children: [
                          ...
                          Container(
                              ...
                              child: Text('$next_card',style: TextStyle(fontFamily: 'Inter', fontSize: 25, color: Colors.black),)),
                        ],
                      )
                  ),
                ],
